...
```
##   Dataset_Name Data_Source Data_Type        Source_Link     Key_variables
## 1     Dataset1        NOAA   Climate https://www.link1/     precipitation
## 2     Dataset2        NRCS Hydrology     https://link2/ soil_conductivity
##   Temporal_range Spatial_Coverage Data_Quality       Data_Quality_notes
## 1      2020-2021          Montana         High QCd with no missing data
## 2     1979-today        Juneau_AK     Moderate   some unexpected values
##   Feasibility Feasibility_notes variable_type
## 1        High             note1   explanatory
## 2      Medium             note2      response
```
